...
```
wu-being@ubuntu:~/.../2.misc-platform_driver$ 
wu-being@ubuntu:~/.../2.misc-platform_driver$ make -C /usr/src/linux-headers-3.13.0-32-generic/ M=/home/wu-being/.../2.misc-platform_driver/
make: Entering directory `/usr/src/linux-headers-3.13.0-32-generic'
  CC [M]  /home/wu-being/.../2.misc-platform_driver/misc-platform_driver.o
  Building modules, stage 2.
  MODPOST 1 modules
  CC      /home/wu-being/.../2.misc-platform_driver/misc-platform_driver.mod.o
  LD [M]  /home/wu-being/.../2.misc-platform_driver/misc-platform_driver.ko
make: Leaving directory `/usr/src/linux-headers-3.13.0-32-generic'
wu-being@ubuntu:~/.../2.misc-platform_driver$ 
wu-being@ubuntu:~/.../2.misc-platform_driver$ 
wu-being@ubuntu:~/.../2.misc-platform_driver$ sudo insmod misc-platform_driver.ko 
wu-being@ubuntu:~/.../2.misc-platform_driver$ 
wu-being@ubuntu:~/.../2.misc-platform_driver$ 

wu-being@ubuntu:~/.../2.misc-platform_driver$ lsmod |grep misc
...
wu-being@ubuntu:~/.../2.misc-platform_driver$ 
wu-being@ubuntu:~/.../2.misc-platform_driver$ ls /dev/ -l |grep misc
wu-being@ubuntu:~/.../2.misc-platform_driver$ 
...
wu-being@ubuntu:~/.../2.misc-platform_driver$ ls /sys/bus/platform/drivers/misc_platform_driver-name/
bind  module  uevent  unbind
wu-being@ubuntu:~/.../2.misc-platform_driver$ ls /sys/bus/platform/drivers/misc_platform_driver-name/ -l
total 0
...
wu-being@ubuntu:~/.../2.misc-platform_driver$ ls /sys/module/misc_platform_d
misc_platform_device/ misc_platform_driver/ 

wu-being@ubuntu:~/.../2.misc-platform_driver$ ls /sys/module/misc_platform_device/
coresize    holders/    initsize    initstate   notes/      refcnt      sections/   srcversion  taint       uevent      
wu-being@ubuntu:~/.../2.misc-platform_driver$ ls /sys/module/misc_platform_device/


wu-being@ubuntu:~/.../2.misc-platform_driver$ ls /sys/bus/platform/drivers/
...
wu-being@ubuntu:~/.../2.misc-platform_driver$ ls /sys/bus/platform/devices/
...
wu-being@ubuntu:~/.../2.misc-platform_driver$ ls /sys/bus/platform/drivers/misc_platform_device+driver-name/ -l
total 0
...
wu-being@ubuntu:~/.../2.misc-platform_driver$ 
wu-being@ubuntu:~/.../2.misc-platform_driver$ 
wu-being@ubuntu:~/.../2.misc-platform_driver$ sudo rmmod misc_platform_driver 
wu-being@ubuntu:~/.../2.misc-platform_driver$ sudo rmmod misc_platform_device 
wu-being@ubuntu:~/.../2.misc-platform_driver$ 
wu-being@ubuntu:~/.../2.misc-platform_driver$ sudo dmesg -c |grep misc_platform
...
wu-being@ubuntu:~/.../2.misc-platform_driver$ 
wu-being@ubuntu:~/.../2.misc-platform_driver$ 
wu-being@ubuntu:~/.../2.misc-platform_driver$ ls /sys/bus/platform/
...
wu-being@ubuntu:~/.../2.misc-platform_driver$ ls /sys/bus/platform/drivers/misc_platform_device+driver-name/
bind    module/ uevent  unbind  
wu-being@ubuntu:~/.../2.misc-platform_driver$
wu-being@ubuntu:~/.../2.misc-platform_driver$ ls /sys/bus/platform/drivers/misc_platform_device+driver-name/ -l
total 0
...
```
```
wu-being@ubuntu:~/.../2.misc-platform_driver$ ls /dev/ |grep misc
wu-being@ubuntu:~/.../2.misc-platform_driver$ 
wu-being@ubuntu:~/.../2.misc-platform_driver$ 
wu-being@ubuntu:~/.../2.misc-platform_driver$ sudo insmod ../2.misc-platform_device/misc-platform_device.ko 
wu-being@ubuntu:~/.../2.misc-platform_driver$ 
wu-being@ubuntu:~/.../2.misc-platform_driver$ 
wu-being@ubuntu:~/.../2.misc-platform_driver$ ls /sys/devices/platform/misc_platform_device+driver-name/ -l
total 0
...
wu-being@ubuntu:~/.../2.misc-platform_driver$ 
wu-being@ubuntu:~/.../2.misc-platform_driver$ 
wu-being@ubuntu:~/.../2.misc-platform_driver$ sudo dmesg  |grep misc_platform
