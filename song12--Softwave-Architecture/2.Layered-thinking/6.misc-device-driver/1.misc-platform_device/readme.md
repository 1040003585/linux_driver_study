...
build error:
```
wu-being@ubuntu:~/.../1.misc-platform_device$ make -C /usr/src/linux-headers-3.13.0-32-generic/ M=/home/wu-being/.../1.misc-platform_device/
make: Entering directory `/usr/src/linux-headers-3.13.0-32-generic'
  CC [M]  /home/wu-being/.../1.misc-platform_device/misc-platform_device.o
/home/wu-being/.../1.misc-platform_device/misc-platform_device.c: In function ‘misc_platform_device_init’:
/home/wu-being/.../1.misc-platform_device/misc-platform_device.c:18:2: error: implicit declaration of function ‘platform_device_alloc’ [-Werror=implicit-function-declaration]
  pdev = platform_device_alloc("misc_platform_device-name", -1);
  ^
/home/wu-being/.../1.misc-platform_device/misc-platform_device.c:18:7: warning: assignment makes pointer from integer without a cast [enabled by default]
  pdev = platform_device_alloc("misc_platform_device-name", -1);
       ^
/home/wu-being/.../1.misc-platform_device/misc-platform_device.c:22:2: error: implicit declaration of function ‘platform_device_add’ [-Werror=implicit-function-declaration]
  ret = platform_device_add(pdev);
  ^
/home/wu-being/.../1.misc-platform_device/misc-platform_device.c:24:3: error: implicit declaration of function ‘platform_device_put’ [-Werror=implicit-function-declaration]
   platform_device_put(pdev);
   ^
/home/wu-being/.../1.misc-platform_device/misc-platform_device.c: In function ‘misc_platform_device_exit’:
/home/wu-being/.../1.misc-platform_device/misc-platform_device.c:34:2: error: implicit declaration of function ‘platform_device_unregister’ [-Werror=implicit-function-declaration]
  platform_device_unregister(pdev);
  ^
cc1: some warnings being treated as errors
make[1]: *** [/home/wu-being/.../1.misc-platform_device/misc-platform_device.o] Error 1
make: *** [_module_/home/wu-being/.../1.misc-platform_device] Error 2
make: Leaving directory `/usr/src/linux-headers-3.13.0-32-generic'
wu-being@ubuntu:~/.../1.misc-platform_device$ 
...
```
wu-being@ubuntu:~/.../1.misc-platform_device$ 
wu-being@ubuntu:~/.../1.misc-platform_device$ sudo insmod misc-platform_device.ko 
...
make: Entering directory `/usr/src/linux-headers-3.13.0-32-generic'
  ...
  MODPOST 1 modules
  CC      /home/wu-being/.../1.misc-platform_device/misc-platform_device.mod.o
  LD [M]  /home/wu-being/.../1.misc-platform_device/misc-platform_device.ko
make: Leaving directory `/usr/src/linux-headers-3.13.0-32-generic'
wu-being@ubuntu:~/.../1.misc-platform_device$ 
wu-being@ubuntu:~/.../1.misc-platform_device$ 
```
...
wu-being@ubuntu:~/.../1.misc-platform_device$ ls /sys/
block/      bus/        class/      dev/        devices/    firmware/   fs/         hypervisor/ kernel/     module/     power/      

wu-being@ubuntu:~/.../1.misc-platform_device$ ls /sys/devices/
breakpoint/  LNXSYSTM:00/ platform/    pnp1/        software/    tracepoint/  
isa/         pci0000:00/  pnp0/        rapidio/     system/      virtual/   
  
wu-being@ubuntu:~/.../1.misc-platform_device$ ls /sys/dev/
block/ char/  
...
wu-being@ubuntu:~/.../1.misc-platform_device$ 
wu-being@ubuntu:~/.../1.misc-platform_device$ 
wu-being@ubuntu:~/.../1.misc-platform_device$ ls /sys/devices/platform/ -l
total 0
...
wu-being@ubuntu:~/.../1.misc-platform_device$ 
wu-being@ubuntu:~/.../1.misc-platform_device$ ls /sys/devices/platform/misc_platform_device-name/ -l
total 0
...
wu-being@ubuntu:~/.../1.misc-platform_device$ 
wu-being@ubuntu:~/.../1.misc-platform_device$ ls /sys/bus/platform/
devices/           drivers/           drivers_autoprobe  drivers_probe      uevent             
wu-being@ubuntu:~/.../1.misc-platform_device$ ls /sys/bus/platform/drivers
...
wu-being@ubuntu:~/.../1.misc-platform_device$ ls /sys/bus/platform/devices/
...
```
```
wu-being@ubuntu:~/.../1.misc-platform_device$ ls /sys/bus/platform/drivers -l
total 0
...
```
```
wu-being@ubuntu:~/.../1.misc-platform_device$ ls /sys/bus/platform/devices/ -l 
total 0
...
wu-being@ubuntu:~/.../1.misc-platform_device$ ls /sys/bus/platform/devices/ -l |grep misc
lrwxrwxrwx 1 root root 0 May 20 15:03 misc_platform_device-name -> ../../../devices/platform/misc_platform_device-name


wu-being@ubuntu:~/.../1.misc-platform_device$ ls /sys/bus/platform/drivers/ -l |grep misc
wu-being@ubuntu:~/.../1.misc-platform_device$ 
wu-being@ubuntu:~/.../1.misc-platform_device$ 
wu-being@ubuntu:~/.../1.misc-platform_device$ 
